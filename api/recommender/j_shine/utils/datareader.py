...
class DataReader:
    def __init__(self, train_fname = "../data/data_json/train.json",
        ...
        if only_load:
            train_fname_csv = "./recommender/j_shine/data/data_csv/train.csv"
            val_fname_csv = "./recommender/j_shine/data/data_csv/val.csv"
            val_pid_fname_csv = "./recommender/j_shine/data/data_csv/val_pid.csv"
            test_fname_csv = "./recommender/j_shine/data/data_csv/test.csv"
            all_fname_csv = "./recommender/j_shine/data/data_csv/all.csv"

            train_fname_csv = os.path.join(pathlib.Path().absolute(), train_fname_csv)
            val_fname_csv = os.path.join(pathlib.Path().absolute(), val_fname_csv)
            val_pid_fname_csv = os.path.join(pathlib.Path().absolute(), val_pid_fname_csv)
            test_fname_csv = os.path.join(pathlib.Path().absolute(), test_fname_csv)
            all_fname_csv = os.path.join(pathlib.Path().absolute(), all_fname_csv)
